    ...
    <div class="clearfix selector">
        <div class="type-wrap logo">
            ...
            <div class="value logos">
                <ul class="logo-list" @click="searchForTrademark">
                    <li data-name="1:索尼">索尼（SONY）</li>
                    <li data-name="2:TCL">TCL</li>
                    <li data-name="3:长虹">长虹（CHANGHONG）</li>
                    <li data-name="4:飞利浦">飞利浦（PHILIPS）</li>
                    <li data-name="5:风行电视">风行电视</li>
        ...
        <div @click.prevent="searchForAttr">
            <div class="type-wrap">
...
export default {
    ...
    methods: {
        // 点击品牌的回调
        searchForTrademark({ target }) {
            // 应当在这个回调当中，把searchParams中的trademark修改
            // 发送请求
            if (target.dataset.name) {
                this.$emit("searchForTrademark", target.dataset.name);
            }
        },
        // 点击平台属性值的回调
        searchForAttr({ target }) {
            if (target.nodeName === "A") {
                this.$emit("searchForAttr", target.innerText);
            }
        },
    },
};
