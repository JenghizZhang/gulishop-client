                ...
                <div class="InfoWrap">
                    ...
                    <div class="choose">
                        <div class="chooseArea">
                            ...
                            <dl @click="changeChecked(1, $event)">
                                <dt class="title">选择颜色</dt>
                                <dd
                                    data-name="1"
                                    changepirce="0"
                                    :class="{ active: checkedAttr[0] === 1 }"
                                >
                                    金色
                                </dd>
                                <dd
                                ...
                                <dd
                                    data-name="3"
                                    changepirce="90"
                                    :class="{ active: checkedAttr[0] === 3 }"
                                >
                                    黑色
                                </dd>
                            </dl>
                            <dl @click="changeChecked(2, $event)">
                                <dt class="title">内存容量</dt>
                                <dd
                                    data-name="1"
                                    changepirce="0"
                                    :class="{ active: checkedAttr[1] === 1 }"
                                >
                                    16G
                                </dd>
                                <dd
                                ...
                                <dd
                                    data-name="4"
                                    changepirce="1300"
                                    :class="{ active: checkedAttr[1] === 4 }"
                                >
                                    256G
                                </dd>
                            </dl>
                            <dl @click="changeChecked(3, $event)">
                                <dt class="title">选择版本</dt>
                                <dd
                                    data-name="1"
                                    changepirce="0"
                                    :class="{ active: checkedAttr[2] === 1 }"
                                >
                                    公开版
                                </dd>
                                <dd
                                    data-name="2"
                                    changepirce="-1000"
                                    :class="{ active: checkedAttr[2] === 2 }"
                                >
                                    移动版
                                </dd>
                            </dl>
                            <dl @click="changeChecked(4, $event)">
                                <dt class="title">购买方式</dt>
                                <dd
                                    data-name="1"
                                    changepirce="0"
                                    :class="{ active: checkedAttr[3] === 1 }"
                                >
                                    官方标配
                                </dd>
                                <dd
                        ...
                        <div class="cartWrap">
                            ...
                            <div class="add">
                                <!-- 
                                    之前我们的跳转几乎都是点击直接就跳转，因为我们在跳转的时候
                                    不需要发请求，比如从home页到search页或search去detail，跳转
                                    的时候不需要发请求而是跳转过去后发请求拿数据。而加入购物车，
                                    当我门点击添加购物车，我们需要先发请求给后台，后台需要把这个
                                    购物车信息存储数据库，请求成功之后会返回给我们信息，然后我们
                                    根据这个信息再去跳转，否则有可能出现后台添加数据库失败，但是
                                    已经跳转到下个页面的情况
                                 -->
...
export default {
        ...
        imgList() {
            return (
                [
                    ...
                    { imgUrl: "/images/floor-1-2.png" },
                    { imgUrl: "/images/floor-1-3.png" },
                    { imgUrl: "/images/floor-1-4.png" },
                ] || [{ imgUrl: undefined }]
            );
        },
    },
    methods: {
        ...
        changeChecked(item, { target }) {
            if (target.nodeName === "DD") {
                this.checkedAttr.splice(
                    item - 1,
                    1,
                    Number(target.dataset.name)
                );
            }
        },
        // 点击添加购物车的回调
        addShopCart() {
            // 第一步：先发请求添加购物车
            this.$store
                .dispatch("shopCart/addOrUpdateShopCart", {
                    skuId: this.skuId,
                    skuNum: this.skuNum,
                })
                .then((result) => {
