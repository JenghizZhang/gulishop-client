...
export default {
    ...
    data() {
        return {
            ...
            payInfo: {
                totalFee: 10798,
                codeUrl: "wxp://f2f0zsXkyssEIDrPxpBZxVqpEMNid1NFcDw3",
            },
            payStatus: false,
        };
    },
        ...
        async pay() {
            ...
            try {
                ...
                this.$alert(`<img src='${imgUrl}'/>`, "请使用微信扫码支付", {
                    ...
                    center: true,
                    roundButton: true,
                    beforeClose: (action, instarnce, done) => {
                        // action表示点击的是哪个安妞 confirm cancel close
                        if (action === "confirm") {
                            if (this.payStatus) {
